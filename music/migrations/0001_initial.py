...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('base_music', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='base_music', to='music.Music')),
                ('similar_music', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='similar_music', to='music.Music')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('base_album', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='base_album', to='music.Album')),
                ('similar_album', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='similar_album', to='music.Album')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='music.SimilarMusic', to='music.Music'),
        ),
        migrations.AddField(
            model_name='magazine',
            name='music',
        ...
        migrations.AddField(
            model_name='album',
            name='similar_relation',
            field=models.ManyToManyField(through='music.SimilarAlbum', to='music.Album'),
        ),
    ]
